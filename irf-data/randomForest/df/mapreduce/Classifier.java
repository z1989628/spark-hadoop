...
// Mapreduce implementation that classifies the Input data using a previously built decision forest
...
public class Classifier {
	...
	private final Path outputPath; // path that will contain the final output of the classifier
	...
	public static class CMapper extends Mapper<LongWritable, Text, DoubleWritable, Text> {
		...
		protected void setup(Context context) throws IOException, InterruptedException {
			super.setup(context);		// To change body of overriden methods use File | Settings | File Templates.
